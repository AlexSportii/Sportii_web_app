            ...
            <main className="flex-grow pb-12">
                ...
                <div className="relative h-[40vh] w-full">
                    ...
                    <div className="absolute top-24 left-4 sm:left-8">
                        <Link href="/games" className="flex items-center gap-2 text-white/90 hover:text-white transition-colors bg-black/40 px-3 py-1.5 rounded-xl backdrop-blur-md">
