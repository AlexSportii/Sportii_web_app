...
const GamesCard: React.FC<{ onJoinGame?: () => void }> = ({ onJoinGame }) => {
        ...
        <section className="py-12 bg-gray-50 dark:bg-black/20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-end mb-8">
                    ...
                    <Link href="/games" className="hidden sm:flex text-primary font-semibold hover:text-blue-600 items-center gap-1 group">
                        See all games
